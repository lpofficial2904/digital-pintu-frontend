...
export default function BlogDetails() {
  ...
  useEffect(() => { fetch(`${API_URL}/${encodeURIComponent(slug)}`).then((response) => { if (!response.ok) throw new Error(); return response.json(); }).then(setBlog).catch(() => setError("This blog could not be found.")); }, [slug]);
